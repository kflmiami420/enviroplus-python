...
#you can switch modes by tapping gently on the light sensor
#added mode for temp for Fahrenheit
#added mode for different pressure readings Pascals , InHg , Mbar
import time
import colorsys
import os
import sys
